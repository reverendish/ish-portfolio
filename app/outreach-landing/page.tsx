    ...
    <>
      ...
      <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', padding: '100px 32px 80px', position: 'relative', zIndex: 1, overflow: 'hidden', background: 'var(--bg)' }}>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', width: '100%', position: 'relative', zIndex: 2 }}>
          ...
          <FadeIn delay={1100}>
            <button onClick={openModal} style={{ background: 'var(--accent)', color: 'var(--accent-fg)', fontWeight: 700, border: 'none', borderRadius: 'var(--radius)', padding: '13px 22px', fontSize: '0.95rem', cursor: 'pointer' }}>
              Get in touch →
            </button>
          </FadeIn>
        </div>
          ...
          <FadeIn>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <a href="https://github.com/reverendish/mcp-x-mac-seed" style={{ textDecoration: 'none', display: 'block' }}>
                <div
                  style={{ padding: '32px', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', transition: 'border-color 0.2s' }}
